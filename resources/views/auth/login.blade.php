				...
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(assets/media/bg/bg-4.jpg);">
					...
					<div class="d-flex flex-row-fluid flex-column justify-content-between">
						...
						<div class="flex-column-fluid d-flex flex-column justify-content-center">
							...
							<p class="font-weight-lighter text-white opacity-80">موقع اخباري في جميع المجالات</p>
						</div>
						<!--end: Aside content-->
						...
						<div class="login-form login-signin">
							...
							<form method="POST" action="{{ route('login') }}" class="form" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-5 px-6" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
