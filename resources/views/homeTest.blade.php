		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
							<img alt="Logo" src="{{asset('assets/media/Supernews-Logo.png')}}" style="width: 200px;" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<div class="aside-menu-wrapper flex-column-fluid " id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<!--begin::Menu Nav-->
							<ul class="menu-nav" aria-haspopup="true">
                                @can('show users')
                                <li class="menu-item">
                                    <a href = "{{ route('admin.users') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-users "></i>
                                        <span class="menu-text h3">Users</span>
                                    </a>
                                ...
                                <li class="menu-item">
                                    <a href = "{{ route('admin.roles.create') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-users "></i>
                                        <span class="menu-text h3">Add Role</span>
                                    </a>
                                ...
                                @can('create user')
                                <li class="menu-item">
                                    <a href = "{{ route('admin.userCreate') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-user "></i>
                                        <span class="menu-text h3">Create User</span>
                                    </a>
                                ...
                                @endcan
                                    ...
                                    @can('create post')
                                <li class="menu-item">
                                    <a href = "{{ route('admin.postShow') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-file"></i>
                                        <span class="menu-text h3">Create Posts</span>
                                    </a>
                                </li>
                                    @endcan
                                <li class="menu-item">
                                    <a href = "{{ route('admin.postTable') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-file"></i>
                                        <span class="menu-text h3">Show Post</span>
                                    </a>
                                </li>
                                    @can('add category')
								<li class="menu-item">
                                        <a href = "{{ route('admin.category.add') }}" class="menu-link">
                                            {{-- <h4 class="menu-text">Custom</h4> --}}
                                            <i class="menu-icon fa fa-file"></i>
                                            <span class="menu-text h3">Add Category</span>
                                        </a>
                                    </li>
                                    @endcan
								@can('show roles')
                                ...
                                <li class="menu-item">
                                    <a href = "{{ route('admin.roles.index') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-file"></i>
                                        <span class="menu-text h3">Show roles</span>
                                    </a>
                                </li>
								@endcan
                                    @can('add permission')
                                <li class="menu-item">
                                    <a href = "{{ route('admin.add.permission') }}" class="menu-link">
                                        {{-- <h4 class="menu-text">Custom</h4> --}}
                                        <i class="menu-icon fa fa-file"></i>
                                        <span class="menu-text h3">Add permission</span>
                                    </a>
                                </li>
                                    @endcan
									<li class="menu-item">
										<a href = "{{ route('admin.notification.form') }}" class="menu-link">
											{{-- <h4 class="menu-text">Custom</h4> --}}
											<i class="menu-icon fa fa-file"></i>
											<span class="menu-text h3">Send Notification</span>
										</a>
									</li>

                                    <li class="menu-item">
                                        <a href = "{{ route('admin.urgent') }}" class="menu-link">
                                            {{-- <h4 class="menu-text">Custom</h4> --}}
                                            <i class="menu-icon fa fa-file"></i>
                                            <span class="menu-text h3">Add Urgent news</span>
                                        </a>
                                    </li>
				...
				<div class="d-flex flex-column flex-row-fluid wrapper bg-white" id="kt_wrapper">
                    ...
                    @yield('userEdit')
					@yield('categoryAdd')
                    @yield('createPermission')
                    @yield('showPermissions')
                    @yield('showRole')
                    @yield('editRole')
                    @yield('addPermission')
					@yield('content')
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex flex-column font-weight-bold">
																...
																<span class="text-muted">
                                                                    ...
                                                                    <br>
                                                                    <small style="color:indianred">{{\Carbon\Carbon::parse($notifications['created_at'])->diffForHumans()}}</small>
                                                                </span>
															</div>
															<!--end::Text-->
														</div>
...
{{--												<!--end::Tabpane-->--}}
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{asset('assets/media/stock-600x400/img-1.png')}}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{asset('assets/media/stock-600x400/img-2.png')}}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{asset('assets/media/stock-600x400/img-3.png')}}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{asset('assets/media/stock-600x400/img-4.png')}}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="{{asset('assets/media/stock-600x400/img-8.png')}}" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
				</div>
									...
									<div class="d-flex flex-column mb-5 align-items-start">
										<div class="d-flex align-items-center">
											<div class="symbol symbol-circle symbol-40 mr-3">
												<img alt="Pic" src="{{asset('assets/media/users/300_12.png')}}" />
											</div>
											<div>
									...
									<div class="d-flex flex-column mb-5 align-items-end">
										<div class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-40 ml-3">
												<img alt="Pic" src="{{asset('assets/media/users/300_21.png')}}" />
											</div>
										</div>
		...
		<script>
			...
			messaging.onMessage(function(payload) {
				...
				// sound.play();
				var audio = new Audio('{{asset('assets/media/notification_sound.wav')}}');
        		audio.play();
